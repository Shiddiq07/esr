...
$config['sess_cookie_name'] = 'ci_session_esr';
...
if (
    ...
    if (stripos($_SERVER["REQUEST_URI"], '/api/') === false ) { // Verify if POST Request is not for API
        $config['csrf_protection'] = CSRF_TOKEN;
    } else {
...
$config['csrf_token_name'] = 'csrf_lpei_esr';
$config['csrf_cookie_name'] = 'csrf_cookie_esr';
$config['csrf_expire'] = CSRF_EXPIRES_IN;
