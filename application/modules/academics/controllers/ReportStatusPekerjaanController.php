...
class ReportStatusPekerjaanController extends CI_Controller
{
	...
	public function actionIndex($src = 'college')
	{
		...
		$this->layout->title = 'Laporan Status Pekerjaan';
...
/* End of file ReportStatusPekerjaanController.php */
/* Location: ./application/modules/academics/controllers/ReportStatusPekerjaanController.php */