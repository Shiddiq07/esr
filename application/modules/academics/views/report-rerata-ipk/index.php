        ...
        <nav class="nav mb-4">
            <div class="container-fluid d-flex">
                <div class="d-flex">
                    ...
                    <?= $this->html->a('COLLEGE', '/academics/report-rerata-ipk/college', [
                        'class' => 'nav-link '. $active_college
                    ]) ?>
                    <?= $this->html->a('LP3I JAKARTA', '/academics/report-rerata-ipk/plj', [
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <div class="row mt-3">
                        <label for="select-jurusan" class="col-sm-3 col-form-label required">Jurusan</label>
                        <div class="col-sm-9">
...
<div class="card" id="panel-recap" style="display: none;">
    <div class="card-header">
        <div class="float-end">
            <div class="dropdown dt-buttons">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" id="table-report-rerata_tools">
    ...
    <div class="card-body py-3">
        <table id="table-report-rerata" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <?php for ($i = 0; $i < $semester; $i++): ?>
                    
                    <th class="text-center"><?= $this->helpers->numberToRoman($i + 1) ?></th>
            ...
            <tbody>
                <tr><td colspan="<?= 4 + $semester ?>"><i>Data belum ada.</i></td></tr>
            </tbody>
        </table>
    </div>
</div>
