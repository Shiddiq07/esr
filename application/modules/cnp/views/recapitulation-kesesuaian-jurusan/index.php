        ...
        <nav class="nav mb-4">
            <div class="container-fluid d-flex">
                <div class="d-flex">
                    ...
                    <?= $this->html->a('COLLEGE', '/cnp/recapitulation-kesesuaian-jurusan/college', [
                        'class' => 'nav-link '. $active_college
                    ]) ?>
                    <?= $this->html->a('LP3I JAKARTA', '/cnp/recapitulation-kesesuaian-jurusan/plj', [
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-9">
                            <?= $this->html->dropDownList('Filter[cabang]', '', [], [
                                'class' => 'form-control',
                                'tabIndex' => 1,
                                'id' => 'select-cabang',
                                'prompt' => '- Pilih -',
...
<div class="card">
    ...
    <div class="card-body">
        <div id="table-recapitulation">
            <?= $this->layout->renderPartial('_table_recap_kesesuaian-jurusan'); ?>
        </div>
    </div>
</div>
