        ...
        <nav class="nav mb-4">
            ...
            <div class="container-fluid d-flex">
                <div class="d-flex">
                    ...
                    <?= $this->html->a('COLLEGE', '/cnp/recapitulation-permintaan/college', [
                        'class' => 'nav-link '. $active_college
                    ]) ?>
                    <?= $this->html->a('LP3I JAKARTA', '/cnp/recapitulation-permintaan/plj', [
...
<div class="card">
    ...
    <div class="card-body">
        <div id="table-recapitulation">
            <?= $this->layout->renderPartial('_table_recap_permintaan-nasional'); ?>
        </div>
    </div>
</div>
