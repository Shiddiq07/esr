        ...
        <nav class="nav mb-4">
            <div class="container-fluid d-flex">
                <div class="d-flex">
                    ...
                    <?= $this->html->a('COLLEGE', '/cnp/recapitulation-proses-bulanan/college', [
                        'class' => 'nav-link '. $active_college
                    ]) ?>
                    <?= $this->html->a('LP3I JAKARTA', '/cnp/recapitulation-proses-bulanan/plj', [
...
<div class="card">
    ...
    <div id="collapseFilter" class="collapse show" aria-labelledby="headingFilter">
        <div class="card-body">
            <?= form_open('/cnp/recapitulation-proses-bulanan/get-table', [
...
<div class="card">
    ...
    <div class="card-body">
        <div id="table-recapitulation">
            <?= $this->layout->renderPartial('_table_recap_proses-bulanan'); ?>
        </div>
    </div>
</div>
