...
<div style="text-align: center;">
    <h2>TABULASI PROSES PENEMPATAN</h2>
    ...
    <table class="table table-bordered text-center small">
        <thead class="bg-primary">
            <tr>
                ...
                <th rowspan="3" class="bg-dark-subtle">PROGRAM</th>
                <th rowspan="3" class="bg-dark-subtle">JUMLAH MAHASISWA/I</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td><?= ($key + 1) ?></td>
                    <td align="left" class="text-nowrap"><?= $recap['namajurusan'] ?></td>
