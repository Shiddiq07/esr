            ...
            <div class="card-body pt-3">
            	<table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table-group">
                    ...
                    <?php
                        ...
                        $barang = [
                            ['id' => 1,'order_id'=>"001", 'nama' => 'Pensil', 'status' => "Pending"],
                            ['id' => 2,'order_id'=>"002", 'nama' => 'Buku', 'status' => "Delivered"],
                            ['id' => 3,'order_id'=>"003", 'nama' => 'Pulpen', 'status' => "Canceled"],
                        ];
                        ...
                        foreach ($barang as $b) {
                            ...
                            echo "<td>" . $b['nama'] . "</td>";
                            echo "<td>" . $b['status'] . "</td>";
                            echo "<td><a href='purchase-receipt/detail' class='btn btn-primary'>Detail</a></td>";
