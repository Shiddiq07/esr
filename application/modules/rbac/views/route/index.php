            ...
            <div class="card-body pt-3">
            	<div class="row mt-3">
		            <div class="col-sm-5">
		                <div class="input-group">
		                    ...
		                    <span class="input-group-btn">
		                        <?= $this->html->a('<span class="bi bi-arrow-repeat"></span>', '/rbac/route/refresh', [
		                            'class' => 'btn btn-light',
		                            'id' => 'btn-refresh'
		                        ]) ?>
		                    </span>
		            ...
		            <div class="col-sm-1 text-center">
		                <br><br>
		                <?= $this->html->a('<span class="bi bi-chevron-double-right"></span>' . $animateIcon, '/rbac/route/assign', [
		                    'class' => 'btn btn-success btn-assign ladda-button',
		                    'data-target' => 'available',
		                    'title' => 'Assign',
		                ]) ?><br><br>
		                <?= $this->html->a('<span class="bi bi-chevron-double-left"></span>' . $animateIcon, '/rbac/route/remove', [
